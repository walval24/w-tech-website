...
<body class="stretched side-push-panel">
    ...
    <div id="side-panel" class="dark">
        ...
        <div id="side-panel-trigger-close" class="side-panel-trigger"><a href="#"><i class="bi-x-lg"></i></a>
        </div>
 ...
 ============================================= -->
  ...
  ============================================= -->
      ...
      ============================================= -->
                        <div id="logo">
                            <a href="/home">
                                <img class="logo-default" srcset="images/logo-bitmap.svg, images/logo-bitmap.svg"
                                    src="images/logo-bitmap.svg
" alt="Canv">
...
" alt="Ca">
  ...
  ============================================= -->
        <section id="slider" class="slider-element">
            ...
            <div class="section dark m-0 border-0 overflow-hidden"
                style="padding: 120px 0; position: relative; z-index: 2;">

                <div class="container">

                    <div class="emphasis-title">
                        <span class="before-heading opm-medium fw-light text-uppercase font-primary">Siamo
                            un'azienda</span>
                        <h1>
                            <span class="text-rotater nocolor" data-separator="|" data-rotate="fadeInLeft"
                                data-speed="6000">
                                <span
                                    class="t-rotate fw-bold font-body opm-medium-word">Creativa|Preparata|Innovativa</span>
                            </span>
                        </h1>
                    </div>

                    {{-- <a href="#" class="button button-border button-light button-circle fw-normal"
                data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250"
                data-offset="70">I nostri Progetti</a> --}}
        ...
        {{-- <div class="hero-video">
            <video playsinline autoplay muted loop>
                <source src="images/section/coding.mp4" type="video/mp4">
  ...
  ============================================= -->
            ...
            <div class="content-wrap py-0">
                ...
                <div id="section-about" class="text-center page-section">
                    ...
                    <div class="container">
                        ...
                        <h2 class="mx-auto mb-5 font-body" style="max-width: 700px; font-size: 40px;">A digital web
                            studio creating stunning &amp; engaging online experiences</h2>

                        <p class="lead mx-auto mb-5" style="max-width: 800px;">Ford Foundation reduce child mortality
                            fight against oppression refugee disruption pursue these aspirations effect. Free-speech
                            Nelson Mandela change liberal; challenges of our times sustainability institutions.</p>

                        <p class="mb-5" style="font-size: 16px;"><a href="#"
                                data-scrollto="#section-services" data-easing="easeInOutExpo" data-speed="1250"
                                data-offset="70" class="more-link">Learn more <i
                                    class="uil uil-angle-right-b"></i></a></p>
                                    ...
                                    <div class="team-image">
                                        ...
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-end"
                                                ...
                                                <a href="#" class="social-icon bg-transparent h-bg-github"
                                                    title="Github">
                                                    <i class="fa-brands fa-github"></i>
                                                    <i class="fa-brands fa-github"></i>
                                                </a>
                                    ...
                                    <div class="team-image">
                                        ...
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-end"
                                                ...
                                                <a href="#" class="social-icon bg-transparent h-bg-flickr"
                                                    title="Flickr">
                                                    <i class="fa-brands fa-flickr"></i>
                                                    <i class="fa-brands fa-flickr"></i>
                                                </a>
                                    ...
                                    <div class="team-image">
                                        ...
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-end"
                                                ...
                                                <a href="#" class="social-icon bg-transparent h-bg-vimeo"
                                                    title="Vimeo">
                        ...
                        <div class="section m-0">
                            <div class="container">
                                <div class="mx-auto text-center" style="max-width: 900px;">
                                    <h2 class="mb-0 fw-light ls-1">We create &amp; craft projects that ooze creativity
                                        in
                                        every aspect. We try to create a benchmark in everything we do. Take a moment to
     ...
     ============================================= -->
                        ...
                        <div class="mt-5 text-center"><a href="#"
                                class="button button-border button-circle fw-semibold">View More Projects</a></div>
                                ...
                                <div class="row posts-md mt-5 col-mb-50 mb-0">
                                        ...
                                        <div class="grid-inner row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="entry-image">
                                                    <a href="#"><img src="images/blog/1.jpg"
                                                            alt="Paris"></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="entry col-md-6">
                                        <div class="grid-inner row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="entry-image">
                                                    <a href="#"><img src="images/blog/2.jpg"
                                                            alt="Paris"></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mt-3 mt-lg-0">
                                    ...
                                    <div class="entry col-md-6">
                                        <div class="grid-inner row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="entry-image">
                                                    <a href="#"><img src="images/blog/3.jpg"
                                                            alt="Paris"></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mt-3 mt-lg-0">
                                                ...
                                                <div class="entry-title text-transform-none">
                                                    <h3 class="fw-normal"><a href="#">Kicking Off Design Party
                                                            in
                                                            Style</a></h3>
                                                </div>
                                                <div class="entry-content">
                                    ...
                                    <div class="entry col-md-6">
                                        <div class="grid-inner row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="entry-image">
                                                    <a href="#"><img src="images/blog/4.jpg"
                                                            alt="Paris"></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mt-3 mt-lg-0">
